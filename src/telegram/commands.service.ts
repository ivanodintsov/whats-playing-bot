...
import { Hears, InjectBot, TelegrafProvider } from 'nestjs-telegraf';
...
export class CommandsService {
  ...
  createSongsKeyboard(songsLinks, uri?: string): tt.InlineKeyboardMarkup | undefined {
  ...
  async share (ctx: Context) {
    ...
    message = await this.bot.telegram.sendPhoto(ctx.chat.id, data.thumb_url || `${this.appConfig.get<string>('SITE')}/images/123.jpg`, {
      parse_mode: 'Markdown',
      reply_markup: keyboard,
